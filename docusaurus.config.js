...
const config = {
  ...
  tagline: 'Learn how to build smart-contracts and DApps',
  url: 'https://www.toolblox.net',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  organizationName: 'Ideevoog', // Usually your GitHub org/user name.
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Twitter',
                href: 'https://twitter.com/tool_blox',
              },
            ],
          },
          {
            ...
            items: [
              {
                label: 'Blog',
                to: 'https://www.toolblox.net/blog',
              },
              {
                label: 'GitHub',
                href: 'https://github.com/Ideevoog',
              },
            ],
          },
        ],
